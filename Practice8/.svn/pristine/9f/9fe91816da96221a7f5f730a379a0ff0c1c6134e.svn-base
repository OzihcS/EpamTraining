...
public class DBManager {
    ...
    public List<User> findAllUsers() {
        ...
        try {
            ...
            System.out.println("Exception: can't find user in db");
    ...
    public List<Group> findAllGroups() {
        ...
        try {
            ...
            System.out.println("Can't find groups in db");
        } catch (IllegalAccessException e) {
    ...
    private boolean insertGroupForUser(User user, Group group) {
        ...
        try {
            ...
            System.out.println("Can't insert user to group");
        } finally {
            close(rs, pstmt, con);
        }
        return result;
    ...
    public Group getGroupById(Integer id) {
        ...
        try {
            ...
            System.out.println("Can't get group by id");
        } catch (IllegalAccessException e) {
            System.out.println("illegal access" + e.getMessage());
        } catch (InstantiationException e) {
            System.out.println("InstantiationException:" + e.getMessage());
    ...
    public List<String> getUserGroups(User user) {
        ...
        try {
            ...
            System.out.println("Can't get user's group");
        } catch (IllegalAccessException e) {
            System.out.println("Illegal access" + e.getMessage());
        } catch (InstantiationException e) {
            System.out.println("InstantiationException:" + e.getMessage());
    ...
    public boolean updateGroup(Group group) {
        ...
        try {
            ...
            System.out.println("Can't update group");
        } catch (IllegalAccessException e) {
            System.out.println("Illegal access" + e.getMessage());
        } catch (InstantiationException e) {
            System.out.println("InstantiationException:" + e.getMessage());
